...
if subtitle_track_count == 0:
    print("⚠️ No subtitle tracks found in Timeline 1!")
    sys.exit(0)
...
output_path = r"c:\TEST\scratch\Timeline_1_Exported.srt"
with open(output_path, "w", encoding="utf-8") as f:
    f.write("".join(srt_lines))

print(f"🎉 Successfully exported Timeline 1 subtitles to {output_path}!")
